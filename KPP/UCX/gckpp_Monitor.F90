...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'HBr            ','ACTA           ','EMISSION       ', &
     'EOH            ','H2             ','HCOOH          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(5) :: SPC_NAMES_2 = (/ &
     'MOH            ','N2             ','O2             ', &
     'RCOOH          ','DUMMY          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(185) :: SPC_NAMES = (/&
    SPC_NAMES_0, SPC_NAMES_1, SPC_NAMES_2 /)

  INTEGER, PARAMETER, DIMENSION(185) :: LOOKAT = (/ &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '  ISNOOA + NO3 --> CO + R4N2 + NO2 + HO2                                                            ', &
     '   ISNOOA + NO --> CO + R4N2 + NO2 + HO2                                                            ', &
     '  ISNOOA + NO2 --> PMN                                                                              ', &
     '  ISNOOA + HO2 --> 0.75 RP + 0.25 O3 + 0.25 RCOOH                                                   ', &
     '  ISNOOB + NO3 --> GLYX + R4N2 + 2 NO2                                                              ', &
     '   ISNOOB + NO --> 0.94 GLYX + 0.94 R4N2 + 1.88 NO2                                                 ', &
     '  ISNOOB + HO2 --> INPN                                                                             ', &
     '  ISNOOB + MO2 --> 0.7 GLYX + 0.7 R4N2 + 0.75 CH2O + 0.7 NO2 + 0.5 HO2 ... etc.                     ', &
     '     ISN1 + O3 --> 0.7 GLYX + 0.3 R4N2 + 0.75 CH2O + 0.7 NO2 + 0.5 HO2 ... etc.                     ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '    MAN2 + MO2 --> 0.375 PROPNN + 0.375 CO + 0.375 MGLY + 0.25 R4N2 + 0.625 CH2O ... etc.           ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    PRN1 + MO2 --> 0.25 ROH + 0.25 RCHO + 0.5 ALD2 + 1.25 CH2O + NO2 + 0.5 HO2 ... etc.             ', &
     '      OH + EOH --> ALD2 + HO2                                                                       ', &
     '      ROH + OH --> RCHO + HO2                                                                       ', &
     '        2 ETO2 --> 2 ALD2 + 2 HO2                                                                   ', &
     '        2 ETO2 --> ALD2 + EOH                                                                       ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   MAN2 + MCO3 --> CO2 + 0.5 PROPNN + 0.5 CO + 0.5 MGLY + 0.5 CH2O + MO2 ... etc.                   ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     ...
     '   ISOPND + OH --> ISOPNDO2                                                                         ', &
     '   ISOPNB + OH --> ISOPNBO2                                                                         ', &
     ' ISOPNDO2 + NO --> 0.13 ETHLN + 0.15 PROPNN + 0.15 GLYC + 0.07 MACRN + 0.44 HAC ... etc.            ', &
     ' ISOPNDO2 + NO --> HNO3                                                                             ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '       BrO + O --> Br + O2                                                                          ', &
     '      CH2O + O --> CO + HO2 + OH                                                                    ', &
     '     O1D + HCl --> 0.24 H + 0.67 OH + 0.67 Cl + 0.09 O + 0.24 ClO + 0.09 HCl ... etc.               ', &
     '     O1D + HBr --> 0.15 H + 0.65 OH + 0.15 BrO + 0.2 O + 0.65 Br + 0.2 HBr ... etc.                 ', &
     '     Cl2 + O1D --> 0.25 Cl2 + 0.75 Cl + 0.25 O + 0.75 ClO                                           ', &
     '    CCl4 + O1D --> 0.14 CCl4 + 2.58 Cl + 0.14 O + 0.86 ClO                                          ', &
     '   CH3Br + O1D --> MO2 + 0.44 BrO + 0.56 Br                                                         ', &
     '  CH2Br2 + O1D --> 0.05 CH2Br2 + 0.95 BrO + 0.05 O + 0.95 Br                                        ', &
     '   CHBr3 + O1D --> 0.32 CHBr3 + 0.68 BrO + 0.32 O + 1.36 Br                                         ', &
     '  HCFC22 + O1D --> 0.28 HCFC22 + 0.17 Cl + 0.28 O + 0.55 ClO                                        ', &
     '   CFC11 + O1D --> 0.12 CFC11 + 1.76 Cl + 0.12 O + 0.88 ClO                                         ', &
     '   CFC12 + O1D --> 0.14 CFC12 + 1.72 Cl + 0.14 O + 0.86 ClO                                         ', &
     '   H1211 + O1D --> 0.36 H1211 + 0.31 BrO + 0.31 Cl + 0.36 O + 0.33 Br + 0.33 ClO ... etc.           ', &
     '   H1301 + O1D --> 0.59 H1301 + 0.41 BrO + 0.59 O                                                   ', &
     'HCFC141b + O1D --> 0.31 HCFC141b + 0.69 Cl + 0.31 O + 0.69 ClO                                      ', &
     'HCFC142b + O1D --> 0.26 HCFC142b + 0.26 O + 0.74 ClO                                                ', &
     ' HCFC123 + O1D --> 0.21 HCFC123 + 0.79 Cl + 0.21 O + 0.79 ClO                                       ', &
     '  CFC113 + O1D --> 0.25 CFC113 + 1.5 Cl + 0.25 O + 0.75 ClO                                         ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_13 = (/ &
     '  CFC114 + O1D --> 0.25 CFC114 + 0.75 Cl + 0.25 O + 0.75 ClO                                        ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_16 = (/ &
     ...
     '           MAP --> MO2 + OH                                                                         ', &
     '         MACRN --> 0.5 CO + MGLY + HAC + 0.5 CH2O + NO2 + HO2                                       ', &
     '          MVKN --> GLYC + MCO3 + NO2                                                                ', &
     '        ISOPNB --> HC5 + NO2 + HO2                                                                  ', &
     '           Br2 --> 2 Br                                                                             ', &
     '           BrO --> O + Br                                                                           ', &
